...
/**
 * Created by Liz on 01/06/2016.
 */
public class ConexionCola extends AsyncTask<URL,String,String> {
    List<String[]> variables;
    FragmentoPartida puntero;

    public ConexionCola(FragmentoPartida p){
