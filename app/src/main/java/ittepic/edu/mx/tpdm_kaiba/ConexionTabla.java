...
/**
 * Created by Liz on 30/05/2016.
 */
public class ConexionTabla extends AsyncTask<URL,String,String> {
    List<String[]> variables;
    FragmentoPuntuaciones puntero;

    public ConexionTabla(FragmentoPuntuaciones p){
